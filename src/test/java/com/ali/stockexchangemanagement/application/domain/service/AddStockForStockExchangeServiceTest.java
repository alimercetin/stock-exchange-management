...
class AddStockForStockExchangeServiceTest {
    ...
    private final AddStockForStockExchangeService service =
            new AddStockForStockExchangeService(loadStockExchangePort, loadStockPort, updateStockExchangePort);
    ...
    void addStockForStockExchangeSucceeds() {
        ...
        service.addStock(stockExchange.getName(), stock.getId());

        then(updateStockExchangePort).should(times(1))
                .updateStockExchange(stockExchangeCaptor.capture());

        assertThat(stockExchangeCaptor.getValue().getStocks()).contains(stock);
    }
    ...
    void givenStockDoesNotExist_thenThrowsInvalidStockNameException() {
        ...
        assertThrows(InvalidStockNameException.class, () ->
                service.addStock(stockExchange.getName(), stockId));
    ...
    void givenStockExchangeDoesNotExist_thenThrowsInvalidStockExchangeNameException() {
        ...
        assertThrows(InvalidStockExchangeNameException.class, () ->
                service.addStock(stockExchangeName, stockId));
    ...
    @Test
    void givenStockAlreadyExistsForStockExchange_thenThrowsStockAlreadyExistForStockExchangeException() {
        Stock stock = savedStock();
        StockExchange stockExchange = defaultStockExchange();
        ...
        assertThrows(StockAlreadyExistForStockExchangeException.class, () ->
                service.addStock(stockExchange.getName(), stock.getId()));
